...
import apiFooter from "../services/ApiFooter";
import Back from "../assets/back.jpeg";

export default class Food extends Component {
  static navigationOptions = {
    title: "FORNECEDORES DE ALIMENTOS",
    headerTitleStyle: {
      fontSize: 16
    }
  };
  ...
  componentDidMount() {
    this.loadProvidersFood();
  }

  loadProvidersFood = async () => {
    const response = await apiFooter.get("/users");
  ...
  renderIntem = ({ item }) => (
    <View style={styles.usersContainer}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          this.props.navigation.navigate("ProviderFood", { provider: item });
        }}
      >
