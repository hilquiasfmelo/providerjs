...
export default class Water extends Component {
  ...
  componentDidMount() {
    this.loadProvidersWater();
  }

  loadProvidersWater = async () => {
    const response = await apiWater.get("/users");
  ...
  renderIntem = ({ item }) => (
    <View style={styles.usersContainer}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          this.props.navigation.navigate("ProviderWater", { provider: item });
        }}
      >
